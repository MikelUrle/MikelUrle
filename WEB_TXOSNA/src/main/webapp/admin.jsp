...
if(request.getAttribute(I_Conexion.ATR_LISTA_CATEGORIAS)!=null){
	...
	out.println("No llego el atributo ATR_LISTA_CATEGORIAS");
}
%>
...
if(request.getAttribute(I_Conexion.ATR_LISTA_PROD) != null) {
	...
	out.println("Error de atributos");
	out.println("No llego el atributo ATR_LISTA_PROD");
}
...
<body style="display: flex">
	...
	<aside style="margin-left: 50px; margin-right: 50px	">
		...
		<table class="table">
		  ...
		  <tbody>
				...
				<label for="texto">Producto:</label><br>
				<input type="text" name="texto" id="texto" maxlength="45" required><br>
				
				<label for="precioMin">PrecioMin</label><br>
				<input type="number" name="precioMin" id="precioMin" min="0" step ="0.01" required><br>
				
				<label for="precioMax">PrecioMax</label><br>
				<input type="number" name="precioMax" id="precioMax" min="0" step ="0.01" required><br>
